  ...
  return (
    <div className="main-container">
      <div className="container2">
        ...
        {/* <div className="radio"><label>Gender*</label></div> <div><input type="radio" value="male" name="male" onChange={handleGenderChange }/>Male<input type="radio" value="female" name="female"/>Female</div> */}
